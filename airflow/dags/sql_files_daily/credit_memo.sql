SELECT 
                ...
                where (PSI_CreditMemo2.creditmemo_date >= DATE_SUB('{{ execution_date.strftime('%Y-%m-%d') }}', INTERVAL 0 DAY)) AND (PSI_CreditMemo2.creditmemo_date <= '{{ execution_date.strftime('%Y-%m-%d') }}')
